...
public class SeleniumUtility {
	 ...
	 */
	{
		filePath = System.getProperty("user.dir") + "data\\data.properties";
	}
	...
	public void takeScreenShotOfThePage(WebDriver driver, String location) {
	    ...
	    try {
	        // Save the screenshot taken to the destination path
	        FileUtils.copyFile(file, new File(location));
	        System.out.println("Screenshot saved successfully at: " + location);
	    } catch (IOException e) {
